...
button_price_project_cost = KeyboardButton('Редактировать проекты/сотрудников')
...
reply_keyboard_planning = ReplyKeyboardMarkup(resize_keyboard=True).add(button_updates, button_price_project_cost,
...
def gen_inline_for_projects(data):
